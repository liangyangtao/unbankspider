...
@Service
public class ComFinanceun extends BaseFilter {
	private String domain = "www.financeun.com";
    // 图片没有下载下来
	public ComFinanceun() {
	...
	public Element removeNoNeedHtmlElement(String url, Document document,
		...
		String cssQuerys[] = new String[] {
				"img[src=http://bbs.unpcn.com/templates/default/images/attachment_image.gif]",
				"div" };
		for (String string : cssQuerys) {
			removeNoNeedElement(element, string);
		}

		String textQuerys[] = new String[] { "更多相关精彩图片请进入" };
