...
@Component
public class ComHc360 extends BaseFilter {
	...
	public Element removeNoNeedHtmlElement(String url, Document document,
			String title) {
		Element element = document.select("div#artical").first();
		String cssQuerys[] = new String[] {
				".editorN",
				"img[src=http://img02.hc360.com/test/201410/201410141741402464.jpg]",
				"img[src=http://style.org.hc360.com/css_hy/images/end_logo/hc_logo_end.jpg]",
				"select", "p[align=left]", "#pageno", ".xianshisynr", "iframe" };
