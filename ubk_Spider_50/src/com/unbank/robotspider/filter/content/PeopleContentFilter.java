...
@Service
public class PeopleContentFilter extends ContentBaseFilter {
	public Logger logger = Logger.getLogger(PeopleContentFilter.class);
	...
	private String domain[] = new String[] { "hb.people.com.cn",
			...
			"politics.people.com.cn", "finance.people.com.cn",
			"51fayan.people.com.cn", "env.people.com.cn",
			"liuyan.people.com.cn", "sz.people.com.cn", "paper.people.com.cn",
			"bj.people.com.cn", "cppcc.people.com.cn", "bbs1.people.com.cn",
			"expo.people.com.cn", "henan.people.com.cn",
			"rencai.people.com.cn", "fangtan.people.com.cn" };

	public PeopleContentFilter() {
	...
	public Element getContentNode(Document document) {
		Element element = assignPossibleElement(document, "#p_content");
		if (element == null) {
			return null;
		}
		return element;
	...
	public void removeNoNeedElementsByCssQuery(Element contentElement) {
		String cssQuerys[] = new String[] { "center", ".zdfy", ".otitle",
				".textcode" };
