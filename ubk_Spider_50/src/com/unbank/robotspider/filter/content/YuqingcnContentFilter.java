...
@Service
public class YuqingcnContentFilter extends ContentBaseFilter {
	public Logger logger = Logger.getLogger(YuqingcnContentFilter.class);

	private String domain = "www.yuqingcn.cn";

	public YuqingcnContentFilter() {
